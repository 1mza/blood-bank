...
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="{{route('governorates.show',$governorate)}}">{{$governorate->name}}</a></li>
...
@section('content')
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$governorate->name}}</span>
            </div>
        </div>
    </div>
    <!-- Default box -->
    <div class="card">
        ...
        <div class="card-body">
            {{html()->modelForm($governorates,'PUT')->class('form')->route('governorates.update',$governorate)->open()}}
