...
@inject('contactus','App\Models\Post')
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{$contact_us->phone}}</li>
...
@section('content')
    <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">{{$contact_us->email}}</span>
            </div>
        </div>
    </div>
    <!-- Default box -->
    <div class="card">
        ...
        <div class="card-body">
            {{html()->modelForm($contactus,'PATCH')->class('form')->route('contact-us.update',$contact_us->id)->open()}}
