...
@inject('contact_us','App\Models\ContactUs')
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="{{route('contact-us.create')}}">Create</a></li>
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{html()->modelForm($contact_us,'POST')->class('form')->attribute('enctype', 'multipart/form-data')->route('contact-us.store')->open()}}
